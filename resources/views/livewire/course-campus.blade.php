<div x-data="{ showcourseCampusForm: false }" class="grid grid-cols-12 gap-4 md:gap-6 p-4">
    <!-- Create courseCampus Section -->
    <div class="col-span-12 space-y-6">
        <div
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <button @click="showcourseCampusForm = !showcourseCampusForm"
                    ...
                    aria-label="Toggle courseCampus creation form" title="Toggle courseCampus Form">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                        stroke="currentColor" class="w-5 h-5 transition-transform duration-200"
                        :class="showcourseCampusForm ? 'rotate-45' : ''">
            ...
            <form wire:submit.prevent="save" x-show="showcourseCampusForm" x-cloak
                ...
                <div class="flex justify-end pt-4 border-t border-gray-200 dark:border-gray-700">
                    <button wire:loading.attr="disabled" wire:target="save" type="submit"
                        ...
                        <div wire:loading wire:target="save" class="flex items-center gap-2">
                            ...
                            <span>Creating courseCampus...</span>
                        </div>
                        <div wire:loading.remove wire:target="save" class="flex items-center gap-2">
                            ...
                            <span>Create Course Campus</span>
                        </div>
                    </button>
                </div>
            </form>
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                        Manage your courseCampuses efficiently. You can create, edit, and delete courseCampuses as needed.
                    </p>
                </div>
                ...
                <div class="mt-3 sm:mt-0">
                    <div class="px-3 py-1.5 bg-blue-50 dark:bg-blue-900/20 rounded-lg inline-block">
                        <span class="text-sm font-medium text-blue-600 dark:text-blue-400">
                            {{ $courseCampuses->total() }} courseCampuses
                        </span>
                    </div>
            ...
            <div class="w-full overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        @forelse ($courseCampuses as $courseCampus)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors duration-200">
                                ...
                                <td class="py-4 px-3">
                                    <p class="font-semibold text-gray-800 dark:text-white font-['Open_Sans']">
                                        {{ $courseCampus->campus->title }}
                                    </p>
                                </td>
                                <td class="py-4 px-3">
                                    <p class="font-semibold text-gray-800 dark:text-white font-['Open_Sans']">
                                        {{ $courseCampus->course->title }}
                                    </p>
                                </td>
                                ...
                                <td class="py-4 px-3">
                                    <div class="flex items-center justify-center gap-3">
                                        ...
                                        <div x-data="{ showTooltip: false }" class="relative">
                                            <button wire:click="edit({{ $courseCampus->id }})"
                                                @click="showcourseCampusForm = true" @mouseenter="showTooltip = true"
                                                ...
                                                aria-label="Edit courseCampus {{ $courseCampus->title }}">
                                        ...
                                        {{-- <x-ui.delete-button method="deletecourseCampus" :payload="$courseCampus->id"
                                            tooltip="Delete courseCampus" :aria-label="'Delete courseCampus ' . $courseCampus->title" confirmTitle="Are you sure?"
                                            confirmText="Do you really want to delete this courseCampus?" /> --}}
                                ...
                                <td colspan="5" class="py-16 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <h3
                                            ...
                                            No Course Campus Found
                                        </h3>
                                        <p class="text-gray-500 dark:placeholder-gray-400 font-['Open_Sans']">
                                            Get started by creating your first courseCampus.
                                        </p>
                                    </div>
                                </td>
                            </tr>
                ...
                @if ($courseCampuses->hasPages())
                    <div class="mt-6 border-t border-gray-200 dark:border-gray-700 pt-4">
                        {{ $courseCampuses->links() }}
                    </div>
                @endif
            </div>
        </div>
    ...
    <div x-data="{ open: false }" x-init="window.addEventListener('swal-confirm', () => {
        Swal.fire({
            title: 'Are you sure?',
            text: 'Do you really want to delete this courseCampus?',
            icon: 'warning',
...
@push('script')
    <script>
        window.addEventListener('courseCampus-saved', event => {
        ...
        window.addEventListener('courseCampus-deleted', event => {
            const Toast = Swal.mixin({
                toast: true,
                position: 'top-end',
                showConfirmButton: false,
