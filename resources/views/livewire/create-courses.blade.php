        ...
        <div
            ...
            <form wire:submit.prevent="save" x-show="showCourseForm" x-cloak
                ...
                <div class="space-y-6">
                    ...
                    {{-- Couese detail title,enrollment_limit --}}
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="space-y-2">
                            <label
                                class="block text-sm font-semibold text-gray-700 dark:text-gray-300 font-['Open_Sans'] flex items-center">
                            ...
                            <!-- Input Field -->
                            <input type="text" placeholder="Enter Course ID" wire:model="title"
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="number" placeholder="Enter Enrollment Limit" wire:model="enroll_limit"
                                class="w-full h-11 rounded-lg border border-gray-300 dark:border-gray-700
                                   bg-white dark:bg-gray-900 px-4 py-2.5 text-sm text-gray-800 dark:text-white
                                   placeholder:text-gray-400 dark:placeholder:text-white/30
                                   focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-50
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        @forelse ($course_details as $course_detail)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors duration-200">
                                ...
                                <td class="py-4 px-3">
                                    <p class="font-semibold text-sm text-gray-800 dark:text-white font-['Open_Sans']">
                                        {{ $course_detail->time_slot->title }}
                                    </p>
                                </td>
                                <td class="py-4 px-3">
                                    <p class="font-semibold text-gray-800 dark:text-white font-['Open_Sans']">
                                        {{ @$course_detail->phase->title }}
                                    </p>
                                </td>
                                <td class="py-4 px-3">
